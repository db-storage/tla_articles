...
假设上述的 Paxos算法不正确，会选定两个或者多个不同的Value，即：
$$
ChosenAt(b_1, v_1) \land  ChosenAt(b_2, v_2)\land v_1 \neq v_2
$$

根据前面描述的过程，这两个选定的 Value必然有自己的Phase2a过程，即执行过

$Phase2a(b_1, v_1)$和$Phase2a(b_2, v_2)$。
